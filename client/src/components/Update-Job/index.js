...
import { updateJob, saveJobAsDraft, fetchJob } from '../../actions/jobActions'
...
import { 
    ...
    CheckBox, 
    AssessmentSection, 
    CTABlock } from '../Create-Job/style'
...
const UpdateJobComponent = ({updateJob, saveJobAsDraft, fetchJob}) => {
...
export default connect(null, { updateJob, saveJobAsDraft, fetchJob})(UpdateJobComponent)