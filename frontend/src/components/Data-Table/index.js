    ...
    return (
        <>
            ...
            <nav className="pagination is-centered is-rounded is-small mt-4 mb-2" role="navigation" aria-label="pagination">
                <span className="pagination-previous" onClick={() => previousPage()} disabled={!canPreviousPage}>Previous</span>
            ...
            <small>Page <strong>{pageIndex + 1} of {pageOptions.length}</strong></small>
        </>
    )
}
