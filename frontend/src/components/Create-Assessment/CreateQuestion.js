...
import { addQuestion } from '../../actions/assessmentActions'
...
const CreateQuestion = ({ errors, setshowEmptyState }) => {
        ...
        <>
            <QuestionsOptionsWrapper>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <span style={{ color: '#1C65E3', cursor: 'pointer' }} onClick={() => setshowEmptyState(true)} >Cancel</span>
                </div>
            </QuestionsOptionsWrapper>
        </>
    )
